...
print(note:='this feature is made possible by __next__ and __iter__ methods - we shall see that an iterable must have support for __iter__, __next__ is optional')
...
print(note:='and we wont be able to again iterate over this object, we have to again create a new object and loop through it')
...
print(note:='this behavior is different from the iterable of list, etc, as we can loop through them again and again')
